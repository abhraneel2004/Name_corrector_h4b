...
async function suggestDataCorrections(input) {
    ...
    try {
        ...
        if (auditData && auditData.anomalies && Array.isArray(auditData.anomalies)) {
            const correctionTable = auditData.anomalies.filter((anomaly)=>anomaly && anomaly.suggestion) // Only include anomalies with suggestions
            .map((anomaly)=>({
                    row: anomaly.row,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ca7efdd5._.js.map